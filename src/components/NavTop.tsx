  ...
  <nav className={styles.navTop}>
    <div className={styles.wrapper}>
      <div className={styles.left}>
        <span className={classNames([styles.leftItem], [styles.leftItemCity])}>
          Москва
        </span>
        <span className={classNames([styles.leftItem], [styles.leftItemMail])}>
          some-coffee@ya.ru
        </span>
    ...
    <nav className={styles.wrapperMobile}>
      ...
      <div>
        <button className={styles.link} onClick={setCloseSearch}>
          <SearchMobile initialColor="white" hoverColor="#787878" />
        </button>
        <button onClick={setCloseAccount} className={styles.link}>
