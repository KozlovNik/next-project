    ...
    <form className={styles.form}>
      ...
      <div className={styles.block}>
        ...
        <div className={styles.para}>
          Добавьте получателя, если вы покупаете не для себя, или хотите, чтобы
          товар забрал другой человек.
        </div>
        <div className={styles.radioWrapper}>
          <label className={styles.radioLabel}>
            <input type="radio" name="receiver" value="лично" /> Я получатель
          </label>
          <label className={styles.radioLabel}>
      ...
      <div className={styles.block}>
        ...
        <div className={styles.radioWrapper}>
          <label className={styles.radioLabel}>
            <input type="radio" name="payment" value="карта" /> Онлайн-оплата
            картой
          </label>
          <label className={styles.radioLabel}>
            <input type="radio" name="payment" value="наличные" /> При получении
          </label>
        </div>
      </div>
      <div className={styles.hl} />
